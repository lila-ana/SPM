...
export default function FullDetail() {
  ...
  return (
    <div>
      <div className="mb-[15px] text-[#4E4E4F] font-bold font-nunito text-[24px] border-b-2 w-[180px] border-[#1b9c85]">
        Description
      </div>
      ...
      <div className="flex items-center gap-[40px]">
        <div className="grid grid-cols-12 gap-[30px] mx-[0px] my-[50px] justify-center items-center">
          <div className="col-span-6 grid w-[400px] h-[150px] border-[1px] rounded-sm border-[#1b9c85]">
            <div className="flex items-center justify-center font-semibold text-[24px] font-nunito text-[#1b9c85]">
              Commerical Bank of Ethiopia{" "}
            </div>
            <div className="flex items-center justify-center font-light text-[20px] font-nunito text-[#1b9c85]">
              Client{" "}
            </div>
          </div>
          <div className="col-span-6 grid w-[400px] h-[150px] border-[1px] rounded-sm border-[#1b9c85]">
            <div className="grid items-center justify-center font-semibold text-[24px] font-nunito text-[#1b9c85]">
              Prime Contractor
            </div>
            <div className="flex items-center justify-center font-light text-[20px] font-nunito text-[#1b9c85]">
              Contract Role{" "}
