  ...
  window.location.replace("/login")}
    ...
    <div>
      ...
      <div>
        ...
        {/* Print */}
            <button 
              class=" m-[20px] flex items-end justify-end text-[#000000] bg-[#AD8317] w-[100px] hover:bg-[#fcfcfc] border-[#AD8317] border-[1px] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              onClick={handlePrint}
            >
                Print
            </button>
