...
import VendorFill from '../Fill/VendorFill'
...
export default function Vendor() {
    ...
    <div className='grid grid-cols-12 gap-4'>
      <div className="col-span-4 stroke-[#1b9c85] w-[285px] h-[200px] rounded-sm hover:shadow-[#1b9c8585] ease-in-out duration-300 shadow-xl   text-[#4E4E4F] font-semibold font-nunito text-[20px] border-[#1b9c85] border-[1px]  ">
         <img 
                  ...
                  <div>
                     <Menu as="div" className="relative inline-block text-left">
                        ...
                        <Menu.Items className="absolute right-0 z-10 mt-2 w-[70px] origin-top-right divide-y divide-[#1b9c85] bg-white shadow-lg ring-opacity-5 focus:outline-none">
						         <div className="">
							      <Menu.Item>
								      <div className="grid rounded-[5px] gap-[15px] items-center justify-center bg-[#1b9c85] ">
									      <div className="grid justify-center items-center pt-[5px]">
                                    <button >
                                       <IoIosCheckmarkCircleOutline className='fill-white w-[20px] h-[20px]'/>
                                    </button>
